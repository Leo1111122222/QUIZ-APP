...
class QuizController extends GetxController {
  ...
  final List<QuestionModel> _questionsList = [
    ...
    QuestionModel(
      ...
      answer: 1,
      options: ['Carbon', 'Oxygen', 'Helium', 'Sodium'],
    ),
    QuestionModel(
      id: 7,
    ...
    QuestionModel(
      id: 8,
      question:
          "What is the process of combining elements to form a new substance called?",
      answer: 1,
      options: ['Combustion', 'Synthesis', 'Oxidation', 'Decomposition'],
    ),
    QuestionModel(
      id: 9,
